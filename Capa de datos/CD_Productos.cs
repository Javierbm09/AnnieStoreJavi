...
namespace Capa_de_datos
{
    public class CD_Productos
    {
        ...
        public CE_Productos Consulta(int IdProducto)
        {
            ...
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            da.SelectCommand.Parameters.Add("@IdArticulos", SqlDbType.Int).Value = IdProducto;
            DataSet ds = new DataSet();
            ds.Clear();  
            da.Fill(ds);
            DataTable dt;
            ...
            productos.Descripcion1 = Convert.ToString(row[9]);
        ...
        public void CD_Insertar(CE_Productos productos)
        {
            ...
            com.Parameters.AddWithValue("@Descripcion", productos.Descripcion1);
            com.ExecuteNonQuery();
        ...
        public void CD_Actualizar(CE_Productos productos)
        {
            ...
            com.Parameters.AddWithValue("@Activo", productos.Activo);
            com.Parameters.AddWithValue("@UnidadMedida", productos.UnidadMedida);
            com.Parameters.AddWithValue("@Descripcion1", productos.Descripcion1);
            com.ExecuteNonQuery();
            com.Parameters.Clear();
            con.CerrarConexion();
        }
